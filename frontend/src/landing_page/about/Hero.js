...
function Hero() {
    return ( 
        <div className='container mb-5'>
            ...
            <div className='row p-5 mt-5 border-top text-muted ' style={{lineHeight:"1.5" , fontSize:"1.2em"}}>
...
<p><a href="" style={{textDecoratison:"None"}}>Rainmatter</a>, our fintech fund and incubator, has invested in several fintech startups with the goal of growing the Indian capital markets.</p>
